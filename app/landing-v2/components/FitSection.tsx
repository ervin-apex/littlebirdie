    ...
    <section className="lb2-fit" id="who-its-for" aria-labelledby="lb2-fit-title">
      <div className="lb2-shell lb2-fit__frame">
        <div className="lb2-fit__heading">
          <h2 id="lb2-fit-title">Who&rsquo;s it <em>for</em></h2>
        </div>
        <div className="lb2-fit__stage" aria-hidden="true">
          <Image className="lb2-fit__for" src={LANDING_V2_MEDIA.fit.forBoard} alt="" width={1614} height={975} sizes="(max-width: 800px) 94vw, 57vw" />
        ...
        <div className="lb2-fit__dont">
          ...
          <p>
            <span>Tell you how to run your business</span>
            <span>Take up your time</span>
            <span>Cost you an arm and a leg</span>
          </p>
        </div>
        <div className="lb2-sr-only">
          <h3>Who it&rsquo;s for</h3>
          <p>Hospitality, retail, gyms, hairdressers, Pilates, foodtrucks and exotic pet stores</p>
